...
if v:version >= 700
  ...
  "agge
  "hi CursorLine ctermbg=DarkGray cterm=NONE guibg=bg 
  "hi CursorColumn ctermbg=DarkGray cterm=NONE guibg=bg
...
"aggelidis
hi NonText ctermbg=bg ctermfg=DarkGray guibg=white guifg=DarkGray gui=none
